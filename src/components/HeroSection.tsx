        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-grid pt-16">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 text-center">
                ...
                <motion.div
                    ...
                    animate="visible"
                    custom={0.4}
                    className="glass-card glow-blue max-w-2xl mx-auto p-6"
                >
                    {/* 卡片顶部：模拟终端标题栏 */}
                    ...
                    <div className="code-block text-left space-y-2">
                        <div>
                        ...
                        <div className="pl-4">
                            ...
                            <span className="text-slate-300"> &apos;&#123;&quot;query&quot;: &quot;AI gateway best practices&quot;&#125;&apos;</span>
                        </div>
                    </div>
                </motion.div>
            </div>
