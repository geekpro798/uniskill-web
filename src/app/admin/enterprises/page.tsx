...
// src/app/admin/enterprises/page.tsx
// 企业管理列表页
                ...
                {enterprises.map((e) => (
                  <tr key={e.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                    <td className="px-6 py-4">
                      <Link href={`/admin/enterprises/${e.account_uid}`} className="flex items-center gap-3 group">
                    ...
                    <td className="px-6 py-4">
                      <Link href={`/admin/enterprises/${e.account_uid}`} className="text-slate-400 hover:text-blue-500 transition-colors">
